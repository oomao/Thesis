...
👉 **[點擊這裡查看線上展示](https://oomao.github.io/Thesis/demo/)**
...
| 功能 | 說明 | 技術 |
|------|------|------|
| 🔍 **論文推薦** | 輸入文章片段，利用 NLP 提取關鍵字並推薦相關文獻 | CKIP 斷詞 + KeyBERT + MySQL |
| 🤖 **AI 偵測** | 偵測文章是否由 AI 生成，標記可疑段落 | 自訓練 Chinese-MacBERT 模型 |
| 📄 **排版輔助** | 多步驟表單輸入論文資訊，一鍵生成符合格式的 PDF | LaTeX 模板引擎 |
| ⭐ **論文評分** | 上傳 PDF 論文，分析各章節 AI 生成比例 | PDF 解析 + AI 偵測模型 |
| 💬 **聊天機器人** | 論文寫作問題即時解答 | OpenAI GPT-4 API |
| 👥 **學術社群** | 好友系統、即時聊天室，促進學術交流 | PHP + Node.js + WebSocket |
...
本系統為畢業專題作品，由以下成員分工開發：
**陳盛茂、黃柏瑜、林士庭、羅珮綺、陳芊慈、李佳軒**
